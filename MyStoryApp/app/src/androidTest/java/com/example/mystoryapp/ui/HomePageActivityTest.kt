...
import com.example.mystoryapp.userinterface.HomePageActivity
import com.example.mystoryapp.userinterface.MainActivity
...
class MainActivityTest {
    ...
    fun loginAndLogout() {
        // Login Test
        onView(withId(R.id.CVEmail)).perform(typeText("aji@gmail.com"), closeSoftKeyboard())
